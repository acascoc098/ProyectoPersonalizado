...
import com.example.proyectopersonalizado.adapter.ViewHHotel
import com.example.proyectopersonalizado.models.Hotel

class AdapterHotel( var listHotel : MutableList<Hotel>,
                    var deleteOnClick: (Int) -> Unit,
                    var updateOnClick: ( Int) -> Unit) : RecyclerView.Adapter<ViewHHotel>(){
    /*
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHHotel {
        ...
        return ViewHHotel(layoutInflater.inflate(layoutItemHotel, parent, false), deleteOnClick, updateOnClick)
    }
    /*
